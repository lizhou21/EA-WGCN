...
parser.add_argument('--lower', dest='lower', action='store_true', help='Lowercase all words.')          # 转换成小写
parser.add_argument('--no-lower', dest='lower', action='store_false')
parser.set_defaults(lower=False)

parser.add_argument('--prune_k', default=2, type=int, help='Prune the dependency tree to <= K distance off the dependency path; set to -1 for no pruning.')
...
parser.add_argument('--score_type', choices=['HE', 'HWE'], default='HE',help='entity_attention. Default HE.')

parser.add_argument('--pooling_l2', type=float, default=0.003, help='L2-penalty for all pooling output.')
...
parser.add_argument('--id', type=str, default='001', help='Model ID under which to save models.')
parser.add_argument('--info', type=str, default='', help='Optional info for the experiment.')

parser.add_argument('--seed', type=int, default=1234)
parser.add_argument('--cuda', type=bool, default=True)
parser.add_argument('--cpu', default=False, help='Ignore CUDA.')
...
model_id = opt['id'] if len(opt['id']) > 1 else '0' + opt['id']     # 模型对应的id
